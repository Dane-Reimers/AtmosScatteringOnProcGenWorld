...
**
** The Readme.txt file that comes with the ZIP file and contains
** some information as to how to use this library. Description of each function
** is given below.
**
** The Copyright.txt file that comes with the ZIP file and contains
...
const char* GLHLIB_API glhGetString(unsigned int language, unsigned int token);
...
void GLHLIB_API glhGetIntegerv(unsigned int pname, int *params);
...
int GLHLIB_API glhGetGLDeviceCaps_GL_1_5(char *errorMessage, int adapterCount, int deviceType, GLCAPS_GL_1_5 *pcaps);
...
//			1 for success
//			-1 for error plus message.
int GLHLIB_API glhGetGLDeviceCaps_GL_2_0(char *errorMessage, int adapterCount, int deviceType, GLCAPS_GL_2_0 *pcaps);
...
//			1 for success
//			-1 for error plus message.
int GLHLIB_API glhGetGLDeviceCaps_ARB_vp_1_0(char *errorMessage, int adapterCount, int deviceType, GLCAPS_ARB_vp_1_0 *pcaps);
...
//			1 for success
//			-1 for error plus message.
int GLHLIB_API glhGetGLDeviceCaps_ARB_fp_1_0(char *errorMessage, int adapterCount, int deviceType, GLCAPS_ARB_fp_1_0 *pcaps);
...
//			1 for success
//			-1 for error plus message.
int GLHLIB_API glhGetGLDeviceCaps_GL2_0_GLSL(char *errorMessage, int adapterCount, int deviceType, GLCAPS_GL_2_0_GLSL *pcaps);
...
int GLHLIB_API glhIsGLExtensionSupported(const char *extensionName);
...
int GLHLIB_API glhIsWGLExtensionSupported(HDC hdc, const char *extensionName);
...
int GLHLIB_API glhCopyOpenGLErrorInto_cBuffer(char *pstring);
...
//			error was not identified.
//UPDATE:	Sunday, March 13, 2005 : Error code added for GL_EXT_framebuffer_object (GL_INVALID_FRAMEBUFFER_OPERATION_EXT)
int GLHLIB_API glhCopyOpenGLErrorInto_cBuffer2(char *pstring, unsigned int &glerror);
...
int GLHLIB_API glhScaleImage_asm386(unsigned int format, unsigned int isUseLinearOrPointSample,
		int dataAlignment,
...
//			dataAlignment must be 1 or 4.
//			Returns 1 if success. 0 for failure, -5 for not yet implemented.
int GLHLIB_API glhScaleImage3D_asm386(unsigned int format, unsigned int isUseLinearOrPointSample,
		int dataAlignment,
...
//			version and is slower (Intel didn't design MMX intelligently).
//			glhScaleImage2_asm386 is a test version and has bugs.
int GLHLIB_API glhScaleImage_asm386_MMX(unsigned int format, unsigned int isUseLinearOrPointSample,
		int dataAlignment,
		int widthin, int heightin,
		unsigned char *datain,
		int widthout, int heightout,
...
//			version and is slower (Intel didn't design MMX intelligently).
//			glhScaleImage2_asm386 is a test version and has bugs.
int GLHLIB_API glhScaleImage2_asm386(unsigned int format, unsigned int isUseLinearOrPointSample,
		int dataAlignment,
		int widthin, int heightin,
		unsigned char *datain,
		int widthout, int heightout,
...
void GLHLIB_API glhTexSubImage2DMipmaps(int xoffset,
...
int GLHLIB_API glhBuild2DMipmaps(int components, int dataAlignment, int width, int height,
...
//			-1 for misuse
int GLHLIB_API glhBuildCubeMapMipmaps(int components, int dataAlignment, int width, int height,
				unsigned int isPromoteToHigherPowerOn, unsigned int format, const unsigned char *data);
...
//int GLHLIB_API glhBuild3DMipmaps(int components, int dataAlignment, int width, int height, int depth,
//				unsigned int isPromoteToHigherPowerOn, unsigned int format, const unsigned char *data);
...
int GLHLIB_API glhBuild2DNormalMipmaps(int components, int dataAlignment, int width, int height, unsigned int isPromoteToHigherPowerOn, unsigned int format, const unsigned char *data);
...
int GLHLIB_API glhBuild2DNormalMipmapsf(int components, int dataAlignment, int width, int height,
...
int GLHLIB_API glhBuildCubeMapNormalMipmaps(int components, int dataAlignment, int width, int height, unsigned int isPromoteToHigherPowerOn, unsigned int format, const unsigned char *data);
int GLHLIB_API glhBuildCubeMapNormalMipmapsf(int components, int dataAlignment, int width, int height,
				unsigned int isPromoteToHigherPowerOn, unsigned int format, const float *data);
...
int GLHLIB_API glhBuildNormalizationCubeMap(int dataAlignment, int width, int height, unsigned int format, unsigned char *data);
int GLHLIB_API glhBuildNormalizationCubeMapf(int dataAlignment, int width, int height, unsigned int format, float *data);
...
void GLHLIB_API glhRandomNumberi(int *result);
void GLHLIB_API glhRandomNumberf(float *result);
...
void GLHLIB_API glhFastFresnelTerm(float *result, float *cosAngle, float refractionIndex, int count);
...
int GLHLIB_API glhPerlinNoise1D(float *result, int interpolationQuality, int mode, int optimize, float posx, float persistence, int numberOfOctaves, int *boolOctave);
...
int GLHLIB_API glhPerlinNoise2D(float *result, int interpolationQuality, int mode, int optimize, float *pos, float persistence, int numberOfOctaves, int *boolOctave);
...
//
//			Returns 1 for sucess, -1 if bad parameter passed
int GLHLIB_API glhPerlinNoise3D(float *result, int interpolationQuality, int mode, int optimize, float *pos, float persistence, int numberOfOctaves, int *boolOctave);
...
void GLHLIB_API glhInitializeHints(unsigned int mode);
...
int GLHLIB_API glhProjectd(double objx, double objy, double objz,
				double *modelview, double *projection,
				int *viewport,
				double *windowCoordinate);
int GLHLIB_API glhProjectf(float objx, float objy, float objz,
...
int GLHLIB_API glhUnProjectd(double winx, double winy, double winz,
				double *modelview, double *projection,
				int *viewport,
				double *objectCoordinates);
int GLHLIB_API glhUnProjectf(float winx, float winy, float winz,
				float *modelview, float *projection,
				int *viewport,
...
int GLHLIB_API glhProjectf_2(int totalVertex4D, float *objectVertex4D,
				float *modelview_projection,
				int *viewport,
				float *windowCoordinate4D);
//			Example: If you have 5 vertices to process, then totalVertex4D=3*5
int GLHLIB_API glhProjectf_3(int totalVertex3D, float *objectVertex3D,
				float *modelview_projection,
				int *viewport,
...
int GLHLIB_API glhUnProjectf_2(int totalVertex4D, float *windowCoordinate4D,
				float *inverse_modelview_projection,
				int *viewport,
				float *objectVertex4D);
int GLHLIB_API glhUnProjectf_3(int totalVertex3D, float *windowCoordinate3D,
				float *inverse_modelview_projection,
				int *viewport,
...
//			NOTE: we ignore w component of windowCoordinate4D
//			Example: If you have 5 vertices to process, then totalVertex4D=4*5
int GLHLIB_API glhProjectf_SSE_Aligned_2(int totalVertex4D, float *objectVertex4D,
				 float *modelview_projection,
				 int *viewport,
				 float *windowCoordinate4D);
//			The following might give a boost in performance. Pentium 3, Pentium 4, Athlon XP
int GLHLIB_API glhProjectf_SSE_Aligned_WarmCache_2(int totalVertex4D, float *objectVertex4D,
				 float *modelview_projection,
				 int *viewport,
				 float *windowCoordinate4D);
//			Same as above, but we don't care about alignment (lower performance)
int GLHLIB_API glhProjectf_SSE_Unaligned_2(int totalVertex4D, float *objectVertex4D,
				 float *modelview_projection,
				 int *viewport,
				 float *windowCoordinate4D);
//PURPOSE:	Returns 0 for success, >0 for singular matrix or division by w=0.0
//			Look at comment for glhProjectf_SSE_Aligned_2
int GLHLIB_API glhUnProjectf_SSE_Aligned_2(int totalVertex4D, float *windowCoordinate4D,
				float *inverse_modelview_projection,
				int *viewport,
				float *objectVertex4D);
//			The following might give a boost in performance. Pentium 3, Pentium 4, Athlon XP
int GLHLIB_API glhUnProjectf_SSE_Aligned_WarmCache_2(int totalVertex4D, float *windowCoordinate4D,
				float *inverse_modelview_projection,
				int *viewport,
				float *objectVertex4D);
//			Same as above, but we don't care about alignment (lower performance)
int GLHLIB_API glhUnProjectf_SSE_Unaligned_2(int totalVertex4D, float *windowCoordinate4D,
				float *inverse_modelview_projection,
				int *viewport,
				float *objectVertex4D);
...
//			Returns always 0.
int GLHLIB_API glhMultiplyMatrixByVector4by4f_1(int totalVector4D, float *vector4D,
				float *matrix,
				float *result4D);
//			This similarly does a matrix multiplication and ignores w of result3D.
//			w of vector3D is assumed to be 1.0
int GLHLIB_API glhMultiplyMatrixByVector4by4f_2(int totalVector3D, float *vector3D,
				float *matrix,
				float *result3D);
//			This similarly does a matrix multiplication and ignores w of result3D.
//			w of vector3D is assumed to be 0.0.
//			This is suitable for transforming normals.
int GLHLIB_API glhMultiplyMatrixByVector4by4f_3(int totalVector3D, float *vector3D,
				float *matrix,
				float *result3D);
...
//			Example: if we have 5 vertices, totalVertex4D=4*5
//			Returns always 0.
int GLHLIB_API glhMultiplyVectorByMatrix4by4f_1(int totalVector4D, float *vector4D,
				float *matrix,
				float *result4D);
//			This similarly does a matrix multiplication and ignores w of result3D.
//			w of vector3D is assumed to be 1.0
int GLHLIB_API glhMultiplyVectorByMatrix4by4f_2(int totalVector3D, float *vector3D,
				float *matrix,
				float *result3D);
//			This similarly does a matrix multiplication and ignores w of result3D.
//			w of vector3D is assumed to be 0.0.
//			This is suitable for transforming normals.
int GLHLIB_API glhMultiplyVectorByMatrix4by4f_3(int totalVector3D, float *vector3D,
				float *matrix,
				float *result3D);
...
//			NOTE: Assuming w of vector4D is any value.
//			Example: if we have 5 vertices, totalVertex4D=4*5
int GLHLIB_API glhMultiplyMatrixByVector4by4f_SSE_Aligned_1(int totalVector4D, float *vector4D,
				float *matrix,
				float *result4D);
//			The following might give a boost in performance. Pentium 3, Pentium 4, Athlon XP
//			This version warms the cache to reduce latency.
//			It avoids cache pollution and reduces unecessary bus traffic.
int GLHLIB_API glhMultiplyMatrixByVector4by4f_SSE_Aligned_WarmCache_1(int totalVector4D, float *vector4D,
				float *matrix,
				float *result4D);
...
void GLHLIB_API glhMultiplyMatrixByMatrix4by4f_1(float *leftMatrix, float *rightMatrix, float *result);
//PURPOSE:	Multiply leftMatrix[16] with rightMatrix[16] and write result to result[16]
//			It does this countMatrix number of times.
//			For example, for 2 matrix mult, countMatrix must be 2.
void GLHLIB_API glhMultiplyMatrixByMatrix4by4f_2(int countMatrix, float *leftMatrix, float *rightMatrix, float *result);
...
//			It does this only once. See glhMultiplyMatrixByMatrix4by4f_2.
void GLHLIB_API glhMultiplyMatrixByMatrix4by4f_SSE_Aligned_WarmCache_1(float *leftMatrix, float *rightMatrix, float *result);

//PURPOSE:	**** 3DNow! version of glhMultiplyMatrixByMatrix4by4f_1
//			Multiply leftMatrix[16] with rightMatrix[16] and write result to result[16]
//			It does this only once. See glhMultiplyMatrixByMatrix4by4f_2.
void GLHLIB_API glhMultiplyMatrixByMatrix4by4f_3DNow(float *leftMatrix, float *rightMatrix, float *result);

//PURPOSE:	**** 3DNow! version of glhMultiplyMatrixByMatrix4by4f_1
//			Multiply leftMatrix[16] with rightMatrix[16] and write result to result[16]
//			It does this only once. See glhMultiplyMatrixByMatrix4by4f_2.
void GLHLIB_API glhMultiplyMatrixByMatrix4by4f_3DNow_1(float *leftMatrix, float *rightMatrix, float *result);
...
int GLHLIB_API glhExtractLookAtFromMatrixd2(double *matrix, double *eyePosition3D, double *center3D, double *upVector3D);
int GLHLIB_API glhExtractLookAtFromMatrixf2(float *matrix, float *eyePosition3D, float *center3D, float *upVector3D);
...
int GLHLIB_API glhIsMatrixRotationMatrixd(double *matrix);
int GLHLIB_API glhIsMatrixRotationMatrixf(float *matrix);
void GLHLIB_API glhExtractAnglesFromRotationMatrixd2(double *matrix, double *xAngleRadians, double *yAngleRadians, double *zAngleRadians);
void GLHLIB_API glhExtractAnglesFromRotationMatrixf2(float *matrix, float *xAngleRadians, float *yAngleRadians, float *zAngleRadians);
...
int GLHLIB_API glhLowerPowerOfTwo(int width, int *widthOpenGL, int height, int *heightOpenGL);

//PURPOSE:	Used in OpenGL, for making image dimension power of 2 by overcompensating.
//			if((width==*widthOpenGL)&&(height==*heightOpenGL)) return 1 else return 0.
int GLHLIB_API glhHigherPowerOfTwo(int width, int *widthOpenGL, int height, int *heightOpenGL);

//PURPOSE:	Used in OpenGL, for making image dimension power of 2 by undercompensating.
//			if(value==*newValue) return 1 else return 0
int GLHLIB_API glhLowerPowerOfTwo2(int value, int *newValue);

//PURPOSE:	Used in OpenGL, for making image dimension power of 2 by overcompensating.
//			if(value==*newValue) return 1 else return 0
int GLHLIB_API glhHigherPowerOfTwo2(int value, int *newValue);
...
void GLHLIB_API glhLoadIdentityd2(double *matrix);
void GLHLIB_API glhLoadIdentityf2(float *matrix);
void GLHLIB_API glhTranslated2(double *matrix, double x, double y, double z);
void GLHLIB_API glhTranslatef2(float *matrix, float x, float y, float z);
void GLHLIB_API glhScaled2(double *matrix, double x, double y, double z);
void GLHLIB_API glhScalef2(float *matrix, float x, float y, float z);
void GLHLIB_API glhRotated2(double *matrix, double angleInRadians, double x, double y, double z);
void GLHLIB_API glhRotatef2(float *matrix, float angleInRadians, float x, float y, float z);
void GLHLIB_API glhRotateAboutXd2(double *matrix, double angleInRadians);
void GLHLIB_API glhRotateAboutXf2(float *matrix, float angleInRadians);
void GLHLIB_API glhRotateAboutYd2(double *matrix, double angleInRadians);
void GLHLIB_API glhRotateAboutYf2(float *matrix, float angleInRadians);
void GLHLIB_API glhRotateAboutZd2(double *matrix, double angleInRadians);
void GLHLIB_API glhRotateAboutZf2(float *matrix, float angleInRadians);
void GLHLIB_API glhPerspectived2(double *matrix, double fovyInDegrees, double aspectRatio, double znear, double zfar);
void GLHLIB_API glhPerspectivef2(float *matrix, float fovyInDegrees, float aspectRatio, float znear, float zfar);
...
void GLHLIB_API glhD3DPerspectiveLHd2(double *matrix, double fovyInDegrees, double aspectRatio, double znear, double zfar);

//glhD3DPerspectiveLHf2 creates a matrix identical to D3DXMatrixPerspectiveOffCenterLH
//The LH means Left Handed.
//I recommend to stick with RH.
void GLHLIB_API glhD3DPerspectiveLHf2(float *matrix, float fovyInDegrees, float aspectRatio, float znear, float zfar);

//glhD3DPerspectiveRHd2 creates a matrix identical to D3DXMatrixPerspectiveOffCenterRH
//The RH means Right Handed.
void GLHLIB_API glhD3DPerspectiveRHd2(double *matrix, double fovyInDegrees, double aspectRatio, double znear, double zfar);

//glhD3DPerspectiveRHf2 creates a matrix identical to D3DXMatrixPerspectiveOffCenterRH
//The RH means Right Handed.
void GLHLIB_API glhD3DPerspectiveRHf2(float *matrix, float fovyInDegrees, float aspectRatio, float znear, float zfar);


void GLHLIB_API glhFrustumd2(double *matrix, double left, double right, double bottom, double top, double znear, double zfar);
void GLHLIB_API glhFrustumf2(float *matrix, float left, float right, float bottom, float top, float znear, float zfar);

//glhD3DFrustumLHd2 creates a matrix identical to D3DXMatrixPerspectiveOffCenterLH
//The LH means Left Handed.
//I recommend to stick with RH.
void GLHLIB_API glhD3DFrustumLHd2(double *matrix, double left, double right, double bottom, double top, double znear, double zfar);

//glhD3DFrustumLHf2 creates a matrix identical to D3DXMatrixPerspectiveOffCenterLH
//The LH means Left Handed.
//I recommend to stick with RH.
void GLHLIB_API glhD3DFrustumLHf2(float *matrix, float left, float right, float bottom, float top, float znear, float zfar);

//glhD3DFrustumRHd2 creates a matrix identical to D3DXMatrixPerspectiveOffCenterRH
//The RH means Right Handed.
void GLHLIB_API glhD3DFrustumRHd2(double *matrix, double left, double right, double bottom, double top, double znear, double zfar);

//glhD3DFrustumRHf2 creates a matrix identical to D3DXMatrixPerspectiveOffCenterRH
//The RH means Right Handed.
void GLHLIB_API glhD3DFrustumRHf2(float *matrix, float left, float right, float bottom, float top, float znear, float zfar);


void GLHLIB_API glhOrthod2(double *matrix, double left, double right, double bottom, double top, double znear, double zfar);
void GLHLIB_API glhOrthof2(float *matrix, float left, float right, float bottom, float top, float znear, float zfar);


//glhD3DOrthoLHd2 creates a matrix identical to D3DXMatrixOrthoOffCenterLH.
//The LH means Left Handed.
//I recommend to stick with RH.
void GLHLIB_API glhD3DOrthoLHd2(double *matrix, double left, double right, double bottom, double top, double znear, double zfar);

//glhD3DOrthoLHf2 creates a matrix identical to D3DXMatrixOrthoOffCenterLH.
//The LH means Left Handed.
//I recommend to stick with RH.
void GLHLIB_API glhD3DOrthoLHf2(float *matrix, float left, float right, float bottom, float top, float znear, float zfar);

//glhD3DOrthoRHd2 creates a matrix identical to D3DXMatrixOrthoOffCenterRH.
//The RH means Right Handed.
void GLHLIB_API glhD3DOrthoRHd2(double *matrix, double left, double right, double bottom, double top, double znear, double zfar);

//glhD3DOrthoRHf2 creates a matrix identical to D3DXMatrixOrthoOffCenterRH.
//The RH means Right Handed.
void GLHLIB_API glhD3DOrthoRHf2(float *matrix, float left, float right, float bottom, float top, float znear, float zfar);


void GLHLIB_API glhMergedFrustumd2(double *matrix, double left, double right, double bottom, double top, double znear, double zfar);
void GLHLIB_API glhMergedFrustumf2(float *matrix, float left, float right, float bottom, float top, float znear, float zfar);
void GLHLIB_API glhMergedPerspectived2(double *matrix, double fovyInDegrees, double aspectRatio, double znear, double zfar);
void GLHLIB_API glhMergedPerspectivef2(float *matrix, float fovyInDegrees, float aspectRatio, float znear, float zfar);
void GLHLIB_API glhFrustumInfiniteFarPlaned2(double *matrix, double left, double right, double bottom, double top, double znear);
void GLHLIB_API glhFrustumInfiniteFarPlanef2(float *matrix, float left, float right, float bottom, float top, float znear);
void GLHLIB_API glhPerspectiveInfiniteFarPlaned2(double *matrix, double fovyInDegrees, double aspecRatio, double znear);
void GLHLIB_API glhPerspectiveInfiniteFarPlanef2(float *matrix, float fovyInDegrees, float aspectRatio, float znear);
void GLHLIB_API glhLookAtd2(double *matrix, double *eyePosition3D, double *center3D, double *upVector3D);
void GLHLIB_API glhLookAtf2(float *matrix, float *eyePosition3D, float *center3D, float *upVector3D);
void GLHLIB_API glhPickMatrixd2(double *matrix, double x, double y, double deltax, double deltay, int *viewport);
void GLHLIB_API glhPickMatrixf2(float *matrix, float x, float y, float deltax, float deltay, int *viewport);
void GLHLIB_API glhMultMatrixd2(double *result_leftMatrix, double *rightMatrix);
void GLHLIB_API glhMultMatrixf2(float *result_leftMatrix, float *rightMatrix);
void GLHLIB_API glhMultMatrixSwappedd2(double *result_rightMatrix, double *leftMatrix);
void GLHLIB_API glhMultMatrixSwappedf2(float *result_rightMatrix, float *leftMatrix);
...
void GLHLIB_API glhTranslatef2_SSE_Aligned(float *matrix, float *xyzw);
void GLHLIB_API glhScalef2_SSE_Aligned(float *matrix, float *xyzw);
void GLHLIB_API glhRotatef2_SSE_Aligned(float *matrix, float angleInRadians, float *xyzw);
//These don't give any benifits
//void GLHLIB_API glhRotateAboutXf2_SSE_Aligned(float *matrix, float angleInRadians);
//void GLHLIB_API glhRotateAboutYf2_SSE_Aligned(float *matrix, float angleInRadians);
//void GLHLIB_API glhRotateAboutZf2_SSE_Aligned(float *matrix, float angleInRadians);

//Most of the other ones aren't called so often so why bother optimizing. (Ex : glhPerspectivef2)

//Likely to get called often
void GLHLIB_API glhMultMatrixf2_SSE_Aligned(float *result_leftMatrix, float *rightMatrix);
void GLHLIB_API glhMultMatrixSwappedf2_SSE_Aligned(float *result_rightMatrix, float *leftMatrix);
...
void GLHLIB_API glhQuickInvertMatrixd2(double *m, double *result);
void GLHLIB_API glhQuickInvertMatrixf2(float *m, float *result);

void GLHLIB_API glhTransposeMatrixd2(double *result, double *m);
void GLHLIB_API glhTransposeMatrixf2(float *result, float *m);

//PURPOSE:	Singular matrix return 0, else 1 for success.
int GLHLIB_API glhInvertMatrixd2(double *m, double *result);
int GLHLIB_API glhInvertMatrixf2(float *m, float *result);
...
void GLHLIB_API glhShadowMatrixd2(double *matrix, double *planeEquation, double *lightPosition);
void GLHLIB_API glhShadowMatrixf2(float *matrix, float *planeEquation, float *lightPosition);
...
//				DrawMyObject();
//				glPopMatrix();
void GLHLIB_API glhConstantSizeMatrixf2(float *newModelview, float *objectCenter, float *modelview_projection, float *modelview, int *viewport);
...
void GLHLIB_API glhGeneralPlanarMirrorf_1(float *matrix, float *ptransformArray);

//PURPOSE:	Same as glhGeneralPlanarMirrorf_1, but ptransformArray is split into ptranslate[3] and pselfRotate[3]
void GLHLIB_API glhGeneralPlanarMirrorf_2(float *matrix, float *ptranslate, float *pselfRotate);
...
void GLHLIB_API glhRotationMatrixFromRotationsf2(float *result_Matrix, float *R1, float *R2);
...
int GLHLIB_API glhCopyErrorInto_cBuffer(char *pstring);
/*Block 14 -end*/
...
int GLHLIB_API glhConvertHeightMapToNormalMap(int dataAlignment, int width, int height, int border, float scaleFactor,
...
//
//UPDATE:	Updated to work with glhGetError. If int returns error, call glhGetError.
int GLHLIB_API glhNormalMapReducer(int dataAlignment, int width, int height, int border, float weightFactor, unsigned int format, const unsigned char *indata, unsigned char *outdata, int param);
...
//UPDATE:	Updated to work with glhGetError. If int returns error, call glhGetError.
int GLHLIB_API glhComputeTangentAndBinormalVectors_v1_f(int totalIndices, unsigned int *pindices, int totalVertex, int numCompVertex, float *pvertex, int numCompNormals, float *pnormals, int numCompTexCoord, float *ptexCoord, int numCompTangent, float *ptangent, int numCompBinormal, float *pbinormal);
int GLHLIB_API glhComputeTangentAndBinormalVectors_v1_f_2(int totalIndices, unsigned short *pindices, int totalVertex, int numCompVertex, float *pvertex, int numCompNormals, float *pnormals, int numCompTexCoord, float *ptexCoord, int numCompTangent, float *ptangent, int numCompBinormal, float *pbinormal);
...
void GLHLIB_API glhComputeReflectedVectorf(float *reflected, float *pincidentVector, float *pnormal, int count);
...
//		using external code.
void GLHLIB_API glhComputeRefractedVectorf(float *refracted, float *pincidentVector, float *pnormal, float eta, int count);
...
void GLHLIB_API glhQuaternionIdentityf(float *quat);

//PURPOSE:	If quat is {0, 0, 0, 1}, returns 1 (GL_TRUE), else 0 (GL_FALSE)
int GLHLIB_API glhQuaternionIsIdentityf(float *quat);

//PURPOSE:	If quat[3] == 1.0, returns 1 (GL_TRUE), else 0 (GL_FALSE)
int GLHLIB_API glhQuaternionIsPuref(float *quat);

//PURPOSE:	Calculate the conjugate of a quat.
//			xyz is simply negated. quat is xyzw
void GLHLIB_API glhQuaternionConjugatef(float *quat);

//PURPOSE:	Calculate the magnitude of a quat.
void GLHLIB_API glhQuaternionMagnitudef(float *magnitude, float *quat);

//PURPOSE:	Calculate the magnitude squared of a quat.
void GLHLIB_API glhQuaternionMagnitudeSquaredf(float *magnitude, float *quat);

//PURPOSE:	Compute dot product between 2 quats.
void GLHLIB_API glhQuaternionDotProductf(float *result, float *quat1, float *quat2);

//PURPOSE:	Calculates the exponential of a quat.
//			quat is expected to be a pure quaternion. See glhQuaternionIsPuref.
void GLHLIB_API glhQuaternionExpf(float *outquat, float *quat);

//PURPOSE:	Calculate the natural logarithm of a quat.
//			quat should be unit quat.
void GLHLIB_API glhQuaternionLnf(float *outquat, float *quat);
...
//			quat[2]*=n;
//			quat[3]*=n;
void GLHLIB_API glhQuaternionNormalizef(float *quat);

//PURPOSE:	outquat = quat1 * quat2
//			If quat1 and quat2 are normalized, outquat will be a unit quat.
void GLHLIB_API glhQuaternionMultiplyf(float *outquat, float *quat1, float *quat2);
...
//		    |     0               0              0          1 |
//
void GLHLIB_API glhQuaternionQuatToRotationMatrixf(float *matrix, float *quat);
...
void GLHLIB_API glhQuaternionQuatToRotationMatrixTf(float *matrix, float *quat);

//PURPOSE:	Build a quat from a 4x4 column major rotation matrix.
//			quat will be automatically normalized.
void GLHLIB_API glhQuaternionRotationMatrixToQuatf(float *quat, float *matrix);

//PURPOSE:	Convert quat to a axis of rotation and an angle in radians.
//			axis will receive xyz.
//			Quat should be normalized.
void GLHLIB_API glhQuaternionQuatToAxisAndAnglef(float *axis, float *angleInRadians, float *quat);

//PURPOSE:	Convert axis of rotation and an angle in radians to quat.
//			axis must be xyz. Should be unit vector.
void GLHLIB_API glhQuaternionAxisAndAngleToQuatf(float *quat, float *axis, float *angleInRadians);

//PURPOSE:	Convert Euler angles into a quat. Angles are in radians.
void GLHLIB_API glhQuaternionEulerAnglesToQuatf(float *quat, float roll, float pitch, float yaw);
...
void GLHLIB_API glhQuaternionSLERPf(float *outquat, float *quat1, float *quat2, float t);
...
void GLHLIB_API glhPackFloatIntoUByte(unsigned char *outputNumber, float inputNumber);
...
void GLHLIB_API glhUnpackUByteIntoFloat(float *outputNumber, const unsigned char *inputNumber);
...
void GLHLIB_API glhFloatToHalf(float infloat, unsigned short &outhalf);
...
//****************************************************************************
//GEOMETRY GENERATION
//This is for replacing GLU code such as gluSphere, gluCylinder.
//For replacing GLUT code such as glutCube, glutTorus.
//
//These functions do not render!!!
//They just generate indices, vertex, normals, texcoords, tangents, binormals (depending on vertex format).
//You must write your own rendering code. Examples are given.
//We use glDrawRangeElements but you can use glDrawElements if you want.
//You can only render as GL_TRIANGLES.
//
//The examples don't use VBO and VAO and they don't use shaders.
...
int GLHLIB_API glhCreateCubef2(glhCubeObjectf2 *pcube);

//PURPOSE:	Delete the arrays allocated with glhCreateCubef2.
//
//RETURN:
//			Always 1.
int GLHLIB_API glhDeleteCubef2(glhCubeObjectf2 *pcube);
...
//Perhaps if you want to deform the object.
//Perhaps if you want to do some physics calculations and collision.
int GLHLIB_API glhCreateCylinderf2(glhCylinderObjectf2 *pcylinder);

//PURPOSE:	Delete the arrays allocated with glhCreateCylinderf2.
//
//RETURN:
//			Always 1.
int GLHLIB_API glhDeleteCylinderf2(glhCylinderObjectf2 *pcylinder);
...
//Perhaps if you want to deform the object.
//Perhaps if you want to do some physics calculations and collision.
int GLHLIB_API glhCreateSpheref2(glhSphereObjectf2 *psphere);

//PURPOSE:	Delete the arrays allocated with glhCreateSpheref.
//
//RETURN:
//			Always 1.
int GLHLIB_API glhDeleteSpheref2(glhSphereObjectf2 *psphere);
...
//Perhaps if you want to deform the object.
//Perhaps if you want to do some physics calculations and collision.
int GLHLIB_API glhCreatePartialSphereStackf2(glhPartialSphereStackObjectf2 *psphere);
...
//RETURN:
//			Always 1
int GLHLIB_API glhDeletePartialSphereStackf2(glhPartialSphereStackObjectf2 *psphere);
...
//Perhaps if you want to deform the object.
//Perhaps if you want to do some physics calculations and collision.
int GLHLIB_API glhCreateTorusf2(glhTorusObjectf2 *ptorus);
...
//RETURN:
//			Always 1
int GLHLIB_API glhDeleteTorusf2(glhTorusObjectf2 *ptorus);
...
//Perhaps if you want to deform the object.
//Perhaps if you want to do some physics calculations and collision.
int GLHLIB_API glhCreateConef2(glhConeObjectf2 *pcone);
...
//RETURN:
//			Always 1
int GLHLIB_API glhDeleteConef2(glhConeObjectf2 *pcone);
...
//Perhaps if you want to deform the object.
//Perhaps if you want to do some physics calculations and collision.
int GLHLIB_API glhCreateTubef2(glhTubeObjectf2 *ptube);

//PURPOSE:	Delete the arrays allocated with glhCreateTubef2.
//
//RETURN:
//			Always 1.
int GLHLIB_API glhDeleteTubef2(glhTubeObjectf2 *ptube);
...
//Perhaps if you want to deform the object.
//Perhaps if you want to do some physics calculations and collision.
int GLHLIB_API glhCreateChamferCylinderf2(glhChamferCylinderObjectf2 *pchamferCylinder);

//PURPOSE:	Delete the arrays allocated with glhCreateChamferCylinderf2.
//
//RETURN:
//			Always 1.
int GLHLIB_API glhDeleteChamferCylinderf2(glhChamferCylinderObjectf2 *pchamferCylinder);
...
void GLHLIB_API glhComputeHSVWithRGBf(float &hue, float &saturation, float &value, float red, float green, float blue);

//PURPOSE:	Using hue, saturation and value, compute red, green and blue.
void GLHLIB_API glhComputeRGBWithHSVf(float &red, float &green, float &blue, float hue, float saturation, float value);

//PURPOSE:	Using hue, saturation and value, compute red, green and blue.
//			Write it to a 32 bit uint. Format is 0xAARRGGBB.
void GLHLIB_API glhComputeBGRAWithHSVfub(unsigned int &bgraColor, float hue, float saturation, float value, float alpha);

//PURPOSE:	Using hue, saturation and value, compute red, green and blue.
//			Write it to a 32 bit uint. Format is 0xAABBGGRR.
void GLHLIB_API glhComputeRGBAWithHSVfub(unsigned int &rgbaColor, float hue, float saturation, float value, float alpha);

//PURPOSE:	Using red, green and blue, compute hue, saturation and value.
//			bgraColor is in 0xAARRGGBB format.
void GLHLIB_API glhComputeHSVWithBGRAubf(float &hue, float &saturation, float &value, float &alpha, unsigned int bgraColor);

//PURPOSE:	Using red, green and blue, compute hue, saturation and value.
//			bgraColor is in 0xAABBGGRR format.
void GLHLIB_API glhComputeHSVWithRGBAubf(float &hue, float &saturation, float &value, float &alpha, unsigned int rgbaColor);
...
int GLHLIB_API glhDoesRayCrossTrianglef(float *rayPoint1, float *rayDirection, float rayDirectionLengthSquared,
...
int GLHLIB_API glhDoesProcessorSupportMMX();
int GLHLIB_API glhDoesProcessorSupportSSE();
int GLHLIB_API glhDoesProcessorSupportSSE2();
int GLHLIB_API glhDoesProcessorSupport3DNow();
int GLHLIB_API glhDoesProcessorSupport3DNowExtended();
int GLHLIB_API glhDoesOSSupportSSE();
...
int GLHLIB_API glhTranslateShader(int shaderTypeIn, const char *pshaderTextIn, int shaderTypeOut, char *pshaderTextOut, int maxLengthOfShaderTextOut);
...
int GLHLIB_API glhGetMaxMipmapCount(int *count, unsigned int target, int width, int height, int depth);
...
int GLHLIB_API glhMemoryUsageWithMipmaps(int *total, unsigned int target, int components, int dataAlignment, int width, int height, int depth, int lowRange, int highRange);
...
int GLHLIB_API glhComputeFrameBufferUsage(int *memoryCount, int width, int height, int includeFrontBuffer, int bitsPerPixel_Color_FrontBuffer, int bitsPerPixel_Color, int depthAndStencilTogether, int depthBufferBits, int stencilBufferBits, int backBufferCount);
...
void GLHLIB_API glhEvaluateCatmullRomCurvef(int numberOfComponentsForVertex, float *pvertex, int intervalCount, const float *controlPoints, int numberOfControlPoints);
